...
public class Maze
{
    ...
    public static void main(String[] args)
    {
        int[][] grid = {
            ...
            { WALL,  WALL, EMPTY, WALL, EMPTY, EMPTY,  WALL,  WALL, EMPTY,  START},
        ...
        if(!solved)
        {
            System.out.println("You have failed to escape. Future acheologists gaze upon your remains in bafflement."); // Did not reach the end.
        }
